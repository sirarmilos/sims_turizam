...
namespace InitialProject.Service
{
    public class TourRequestService
    {
        ...
        {
            List<TourRequest> countryResults, cityResults, guestNumberResults;
            ...
            allTourRequests = cityResults.Intersect(countryResults).Intersect(guestNumberResults).ToList();
